 ...
 */
public class BaggingTrees implements Classifier {
	...
	public int predict(int[] ex) {
	 ...
	 public static void main(String argv[])
		  ...
		  */
		 String filestem = "./src/data/homework";//argv[0];

		 DataSet d = new BinaryDataSet(filestem);

		 Classifier c = new BaggingTrees(d);
